...
function makeMesh(geometry, side) {
	...
	material = new session.settings.material(config);
	console.log(session.water);
	session.water = material;
 ...
 * TODO: more efficient positioning
 */
function torusKnot(radius, tube, p, q, radialSegments, tubularSegments, heightScale) {
	radius = radius || 4;
	tube = tube || 1;
