...
//    session.ctx = settings.ctx;
	...
	session.camera = new THREE.PerspectiveCamera(30, 1, 1, 10000);
    session.camera.position.set(15, 15, 15);
	session.cameraControls = new OrbitControls(session.camera, session.renderer.domElement);
