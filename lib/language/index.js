...
//    session.ctx = settings.ctx;
    ...
    session.elements.camera.position.set(0, 102.5, 22.5);
	...
	light = modules.light.light;

	session.clock = new THREE.Clock();
	modules.lightboard.state = modules.lightboard.empty;
}
