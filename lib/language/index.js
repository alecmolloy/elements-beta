...
function resetSession(settings) {
    "use strict";
    var code = document.getElementsByClassName('ace_text-layer')[0].innerText;
    localStorage.playgroundCode = code.replace(/\u00a0/g, " ");
	...
	session.elements.camera = new THREE.PerspectiveCamera(30, 1, 1, 10000);
    session.elements.camera.position.set(15, 15, 15);
